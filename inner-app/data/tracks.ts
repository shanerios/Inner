...
export const TRACKS: TrackMeta[] = [
...

  {
    id: 'quiet_field',
    title: 'Quiet Field',
    description: 'A quiet meditation field for complete peace and mental spaciousness. Soft, minimal, and steady, it invites the body to settle while awareness remains clear. Frequency Signature: 528 Hz for gentle coherence and heart-centered ease.',
    frequencies: [528],
    frequencyLabel: '528 hz',
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/quiet_field_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/quiet_field_64k.m4a',
    category: 'stillness',
    durationHintMs: 60 * 60 * 1000,
  },

  {
    id: 'soft_descent',
    title: 'Soft Descent',
    description: 'A slow, calming descent for release, rest, and emotional softening. Warm tones and subtle movement help the nervous system loosen its grip and ease into a quieter state. Frequency Signature: 417 Hz for release, transition, and letting go.',
    frequencies: [417],
    frequencyLabel: '417 hz',
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/soft_descent__hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/soft_descent__64k.m4a',
    category: 'renewal',
    durationHintMs: 60 * 60 * 1000,
  },

  {
    id: 'dream_anchor',
    title: 'Dream Anchor',
    description: 'A deep lucid-dreaming soundscape for anchoring awareness at the edge of sleep. Heavy, immersive, and slow-moving, it supports dream-state depth without pulling the mind back to waking. Frequency Signature: 396 Hz for grounding and stability within the dream field.',
    frequencies: [396],
    frequencyLabel: '396 hz',
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/dream_anchor_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/dream_anchor_64k.m4a',
    category: DEEPER_CATEGORY,
    durationHintMs: 60 * 60 * 1000,
  },

  {
    ...
    description: 'A threshold soundscape for maintaining awareness as the mind drifts toward dreaming. Subtle depth and spacious movement support lucid clarity without becoming stimulating. Frequency Signature: 852 Hz for perception, inner order, and heightened awareness.',
    frequencies: [852],
    frequencyLabel: '852 hz',
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/lucid_threshold_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/lucid_threshold_64k.m4a',
    category: DEEPER_CATEGORY,
    durationHintMs: 60 * 60 * 1000,
  },
  ...
  {
    id: 'hypnagogic_gate',
    title: 'Hypnagogic Gate',
    description: 'A dream-entry soundscape for the hypnagogic edge, where waking thought begins to dissolve into imagery. Soft, strange, and immersive, it invites the listener toward the doorway of sleep with awareness intact. Frequency Signature: 741 Hz for intuition, insight, and subtle inner perception.',
    frequencies: [741],
    frequencyLabel: '741 hz',
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/hypnagogic_gate_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/hypnagogic_gate_64k.m4a',
    category: DEEPER_CATEGORY,
    durationHintMs: 60 * 60 * 1000,
  },
...

  {
    ...
    kind: 'chamber',
    loop: false,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Chambers/chamber_one_revised_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Chambers/chamber_one_revised_64k.m4a',
  ...
  // --- Explorer's Grove ---
  {
    ...
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/fireflies_in_a_dreamscape_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/fireflies_in_a_dreamscape_64k.m4a',
  ...
  },
  {
    ...
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/the_sleeping_tree_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/the_sleeping_tree_64k.m4a',
    category: 'explorers_grove',
    durationHintMs: 60 * 60 * 1000,
  },
  {
    ...
    kind: 'soundscape',
    loop: true,
    remote: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/rain_on_the_roof_hq.m4a',
    remoteLow: 'https://f005.backblazeb2.com/file/inner-audio/Soundscapes/rain_on_the_roof_64k.m4a',
    category: 'explorers_grove',
    durationHintMs: 60 * 60 * 1000,
  },
];
