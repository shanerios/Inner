  ...
  return (
    <View style={[styles.panel, standalone && styles.standalonePanel]}>
      ...
      <View style={styles.environmentHeader}>
        ...
        <Text style={[Typography.caption, styles.value]}>{draft.environment === 'ocean' ? 'Ocean' : draft.environment === 'wind' ? 'Wind' : draft.environment === 'fire' ? 'Fire' : draft.environment === 'cosmic' ? 'Cosmic' : draft.environment === 'forest' ? 'Forest' : draft.environment === 'temple' ? 'Temple' : 'Off'}</Text>
      </View>
      <View style={styles.environmentRow}>
        {([{ value: 'none', label: 'Off' }, { value: 'ocean', label: 'Ocean' }, { value: 'wind', label: 'Wind' }, { value: 'fire', label: 'Fire' }, { value: 'cosmic', label: 'Cosmic' }, { value: 'forest', label: 'Forest' }, { value: 'temple', label: 'Temple' }] as const).map(option => {
