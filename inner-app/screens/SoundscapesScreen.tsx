...
Explorer's Grove — a quiet corner beneath the stars, created for young explorers and the grown-ups settling beside them.
...
export default function SoundscapesScreen() {
  ...
  const renderTrackRows = React.useCallback((items: any[]) => items.map((item: any, idx: number) => {
  ...
  }), [navigation, hasContinuing, handleLockedPress, handleSoundscapeStart]);
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <ExplorersGroveAmbient visible={activeCategory === 'explorers_grove'} />
        ...
        >
          ...
          <View style={{ marginBottom: verticalScale(6) }}>
              ...
              >
                {activeCategory === 'explorers_grove'
            ...
            <View style={{ marginTop: verticalScale(8) }}>
              ...
              >
                {activeCategory === 'tuning' && !normalizedQuery ? (
                  ...
                  renderTrackRows(filteredTracks)
                )}
              </ScrollView>
            </View>
          )}
